...
def ajouter(liste):                                       # Permet de creer une tache et de l'ajouter au dictionnaire des tâches 
    
    print('Entrez nom')
    nom=input()
    while verifname(nom,liste)==False:
        nom=input()
    name=nom
    ...
    addElement(liste, Task(name, writes, reads, None))
